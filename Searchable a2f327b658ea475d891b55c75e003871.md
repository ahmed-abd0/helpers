...
| useCustom | if it uses search method that has  #[Search(”col”)] | true or false | true \|false |
| useAddCondition | if it uses search methods that has  #[SearchAdd(”col”)] | true or false | true\|falseddd |
